...
class AdminOperationsServiceImplTest {
    ...
    @Mock private CouponAdminService couponAdminService;
    ...
    void approveRestaurant_callsRestaurantServiceAndAudits() {
        ...
        verify(adminService).recordAudit(
                eq(adminUserId), eq("APPROVE_RESTAURANT"), eq("RESTAURANT"), eq(restaurantId), any(), any());
    }
    ...
    void suspendRestaurant_delegatesWithReason() {
        ...
        verify(adminService).recordAudit(
                eq(adminUserId), eq("SUSPEND_RESTAURANT"), eq("RESTAURANT"), eq(restaurantId), any(), any());
    }
    ...
    void approveDeliveryKyc_delegates() {
        ...
        verify(adminService).recordAudit(
                eq(adminUserId), eq("APPROVE_DELIVERY_KYC"), eq("DELIVERY_PARTNER"), eq(partnerId), any(), any());
    }
    ...
    void overrideOrderStatus_usesAdminActor() {
        ...
        var result = service.overrideOrderStatus(
                credentialId, orderId, new OverrideOrderStatusRequestDto(OrderStatus.CANCELLED, "duplicate"));
