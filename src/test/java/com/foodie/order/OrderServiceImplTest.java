...
class OrderServiceImplTest {
    ...
    @Mock private OrderStatusEventRepository orderStatusEventRepository;
    @Mock private CartCheckoutPort cartCheckoutPort;
    ...
    void confirmAfterPayment_transitionsPlacedToConfirmed() {
        ...
        ArgumentCaptor<com.foodie.order.entity.OrderStatusEvent> captor =
                ArgumentCaptor.forClass(com.foodie.order.entity.OrderStatusEvent.class);
